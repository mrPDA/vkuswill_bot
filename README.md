...
| # | Статья | Тема |
|---|--------|------|
| 1 | *Скоро* | Демо и обзор — как бот собирает корзину голосом |
| 2 | *Скоро* | MCP + GigaChat — как подключить LLM к API ВкусВилл |
| 3 | *Скоро* | 10 граблей function calling на GigaChat |
...
[MIT](LICENSE) — свободное использование, модификация и распространение с сохранением авторства.
