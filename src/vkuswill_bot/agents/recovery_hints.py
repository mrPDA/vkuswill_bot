...
FORCE_MULTI_COURSE_CONTINUATION_HINT = (
    ...
    "Продолжай: вызови recipe_ingredients для КАЖДОГО оставшегося блюда, "
    "найди товары, и только после обработки ВСЕХ блюд создай ОДНУ финальную "
    "корзину через vkusvill_cart_link_create со ВСЕМИ продуктами от ВСЕХ блюд. "
    "Включи в корзину xml_id из ВСЕХ предыдущих поисков."
)
