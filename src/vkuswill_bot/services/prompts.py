...
5. Ты НЕ ЗНАЕШЬ калорийность товаров — НЕ ВЫДУМЫВАЙ её! \
API не возвращает данные о ккал/БЖУ. Если пользователь \
спрашивает калорийность — честно скажи: «К сожалению, \
данные о калорийности недоступны в каталоге ВкусВилл. \
Рекомендую проверить на упаковке товара.»
