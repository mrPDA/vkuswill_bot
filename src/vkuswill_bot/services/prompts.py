...
_FALLBACK_PROFILES: dict[str, str] = {
    ...
    " нескольких блюд (завтрак+обед+ужин+десерт), ты ОБЯЗАН обработать"
    " КАЖДОЕ блюдо. Для каждого: вызови recipe_ingredients, затем найди"
    " товары. Создавай корзину только после обработки ВСЕХ блюд."
    " НЕ создавай корзину после первого блюда — это ошибка.",
