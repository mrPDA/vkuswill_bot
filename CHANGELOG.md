...
- **КБЖУ-сервис (nutrition_lookup)** — новый инструмент для получения калорий, белков, жиров и углеводов на 100 г через USDA FoodData Central API (бесплатный). GigaChat передаёт query на английском, сервис возвращает КБЖУ с пересчётом на указанную порцию.
